    ...
    if (_expression.isEmpty) {
      ...
      try {
        ...
        if (_resultHistory.isEmpty) {
          ...
          lp = LaTexParser(_expression.replaceAll('Ans', '{${_resultHistory[_resultHistory.length-1]}}'), isRadMode: _isRadMode!);
        }
        Expression mathexp = lp.parse();
        debugPrint('Parsed: $mathexp');
...
List<int> deci2frac(num a) {
  ...
  throw 'Unable to transfer decimal to frac';
}
