      ...
      children: <Widget>[
        WebView(
          onWebViewCreated: (controller) {
            controller.loadFlutterAsset("assets/html/homepage.html");
...
class ClearAnimation extends StatefulWidget {
  const ClearAnimation({super.key});

  @override
  ClearAnimationState createState() => ClearAnimationState();
}

class ClearAnimationState extends State<ClearAnimation> with TickerProviderStateMixin {
 ...
 late Animation animation;
  ...
  Widget _buildAnimation(BuildContext context, Widget ? child) {
    return Positioned(
      top: double.parse((10-animation.value/2).toString()),
